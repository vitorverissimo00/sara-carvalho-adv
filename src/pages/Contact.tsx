      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-foreground/60">
            Estamos prontos para analisar o seu caso com a atenção que ele
            merece.
          </p>
        </div>
            ...
            <div className="bg-surface p-8 md:p-12 rounded-3xl border border-border-theme shadow-sm">
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3 ml-1">
                  <input
                    type="checkbox"
                    className="mt-1 rounded border-border-theme text-gold focus:ring-gold"
                    id="privacy"
                  ...
                  >
                    Concordo com o processamento dos meus dados para fins de
                    contato jurídico, conforme a{" "}
                    <a
                      href="/privacidade"
                ...
                <button 
                  ...
                  className={`w-full py-5 rounded-2xl font-bold text-lg transition-all shadow-xl ${
                    isTermsAgreed 
                      ? 'bg-gold text-white hover:bg-gold-dark shadow-gold/10' 
