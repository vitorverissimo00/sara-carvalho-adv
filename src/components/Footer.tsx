    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-foreground/60 text-sm leading-relaxed">
              Especialista em Direito Previdenciário, dedicada a garantir que
              você receba o que é seu por direito com segurança e transparência.
            </p>
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/advsaracarvalho/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-foreground/5 rounded-full hover:bg-gold hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-foreground/60">
              ...
              <li>
                <Link to="/dicas" className="hover:text-gold transition-colors">
                  Dicas e Conteúdos
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border-theme flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-foreground/40">
          <p>
            © {currentYear} Sara Carvalho Advogada. Todos os direitos
            reservados.
          </p>
